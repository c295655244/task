...
function countLetsComment(_obj){
	if(countLetters(_obj,318))
	$(_obj).val($(_obj).val().substr(0 ,318));
	}
//留言字数统计
...
function initMessageTemplate(jsonData,_obj){
	...
	+'<a data-uid="{0}" class="userinfolink pull-left" href="/{1}/"><img src="/media/images/grey.gif" onLoad="getGravatar(this,\'{2}\',{3},{4})" /></a>'
